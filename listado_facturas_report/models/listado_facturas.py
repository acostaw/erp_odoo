...
class ListadoFacturasReportWizard(models.TransientModel):
    _name = 'listado_facturas.report.wizard'
    ...
    def get_report(self):
        ...
        return self.env.ref('listado_facturas_report.recap_report').report_action(self, data=data)


class ReportListadoFacturas(models.AbstractModel):

    _name = 'report.listado_facturas_report.recap_report_view'
