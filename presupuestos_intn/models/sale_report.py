...
class SaleReport(models.Model):
    ...
    organismo_id = fields.Many2one('intn.organismos', string='Organismo', readonly=True)
    unidad_id = fields.Many2one('intn.unidades', string='Unidad', readonly=True)
    departamento_id = fields.Many2one('intn.departamentos', string='Departamento', readonly=True)
    coordinacion_id = fields.Many2one('intn.coordinaciones', string='Coordinación', readonly=True)
    laboratorio_id = fields.Many2one('intn.laboratorios', string='Laboratorio', readonly=True)
